...
class SISContactInfoController extends Controller {
  ...
  public function addressesAction() {
    ...
    return $this->render('KulaK12StudentBundle:SISContactInfo:addresses.html.twig', array('address_types' => $address_types, 'addresses' => $addresses, 'primary_addresses' => $primary_addresses));
  }
  ...
  public function detailAction($id, $sub_id) {
    ...
    return $this->render('KulaK12StudentBundle:SISContactInfo:addresses_detail.html.twig', array('address' => $address));
  }
  ...
  public function add_addressAction() {
    ...
    if ($this->poster()) {
      $address_result = $this->poster()->getAddedIDs('Core.Constituent.Address');
      if ($address_result) {  
        return $this->forward('sis_K12_student_information_addresses', array('record_type' => 'SIS.K12.Student', 'record_id' => $this->record->getSelectedRecordID()), array('record_type' => 'SIS.K12.Student', 'record_id' => $this->record->getSelectedRecordID()));
      }
    }
    
    return $this->render('KulaK12StudentBundle:SISContactInfo:addresses_add.html.twig');
  }
  ...
  public function phonesAction() {
    ...
    return $this->render('KulaK12StudentBundle:SISContactInfo:phones.html.twig', array('phones' => $phones, 'primary_phones' => $primary_phones));
  }
  ...
  public function emailAddressesAction() {
    ...
    return $this->render('KulaK12StudentBundle:SISContactInfo:emailaddresses.html.twig', array('emails' => $emails, 'primary_emails' => $primary_emails));
  }
  ...
  public function emergencyContactsAction() {
    ...
    return $this->render('KulaK12StudentBundle:SISContactInfo:emergencycontacts.html.twig', array('emergency_contacts' => $emergency));
  }
