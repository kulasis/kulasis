...
class SISParentController extends Controller {
  ...
  public function indexAction() {
    ...
    return $this->render('KulaK12StudentBundle:SISParent:index.html.twig', array('addresses' => $addresses, 'phones' => $phones, 'emails' => $emails));
  }
  ...
  public function deleteAction() {
    ...
    return $this->forward('sis_K12_parent_basic');
  ...
  public function childrenAction() {
    ...
    return $this->render('KulaK12StudentBundle:SISParent:children.html.twig', array('children' => $children));
