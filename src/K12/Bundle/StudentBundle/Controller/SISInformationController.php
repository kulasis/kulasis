...
class SISInformationController extends Controller {
  ...
  public function basicAction() {
    ...
    return $this->render('KulaK12StudentBundle:SISInformation:basic.html.twig', array('status' => $status, 'addresses' => $addresses, 'phones' => $phones, 'emails' => $emails));
  }
  ...
  public function demographicAction() {
    ...
    return $this->render('KulaK12StudentBundle:SISInformation:demographic.html.twig', array('student' => $student));
  }
  ...
  public function addAction() {
    ...
    if ($this->form('add', 'K12.Student.Status', 'new', 'K12.Student.Status.StudentID')) {
      ...
      return $this->forward('sis_K12_student_information_basic', array('record_type' => 'SIS.K12.Student', 'record_id' => $student_id), array('record_type' => 'SIS.K12.Student', 'record_id' => $student_id));
    }
    ...
    return $this->render('KulaK12StudentBundle:SISInformation:add.html.twig', array('constituents' => $constituents, 'defaults' => $defaults));
  }
  
  public function add_constituentAction() {
    $this->authorize();
    $this->formAction('sis_K12_student_information_create_constituent');
    ...
    return $this->render('KulaK12StudentBundle:SISInformation:add_constituent.html.twig', array('defaults' => $defaults));
  }
  ...
  public function index_teacherAction() {
    $this->authorize();
    return $this->render('KulaK12StudentBundle:SISInformation:index_teacher.html.twig');
    
  }
  
  public function chooserAction() {
    $this->authorize();
    $data = $this->chooser('SIS.K12.Student')->createChooserMenu($this->request->query->get('q'));
