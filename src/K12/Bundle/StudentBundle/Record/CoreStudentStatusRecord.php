...
class CoreStudentStatusRecord extends Record {
  
  public function getSelectedRecordBarTemplate() {
    return 'KulaK12StudentBundle::CoreRecord/selected_record_student_status.html.twig';
  }
  
  public function getRecordBarTemplate() {
    return 'KulaK12StudentBundle::CoreRecord/record_student_status.html.twig';
  }
  
  public function getFromDifferentType($record_type, $record_id) {
    if ($record_type == 'Core.K12.Student' OR $record_type == 'Core.HEd.Student') {
    ...
    if ($record_type == 'Core.K12.Student.Status') {
      return $record_id;
    }
  }
  ...
  public function getRecordIDStack() {
    ...
    ->join('CORE_ORGANIZATION_TERMS', 'orgterm', 'stustatus.ORGANIZATION_TERM_ID = orgterm.ORGANIZATION_TERM_ID')
    ->join('CONS_CONSTITUENT', 'constituent', 'constituent.CONSTITUENT_ID = stustatus.STUDENT_ID')
  ...
  public function getInfo($record_id) {
    $result = $this->db()->db_select('STUD_STUDENT_STATUS', 'STUD_STUDENT_STATUS')
      ->fields('STUD_STUDENT_STATUS', array('STUDENT_STATUS_ID', 'STUDENT_ID', 'STATUS', 'GRADE', 'RESIDENT', 'ORGANIZATION_TERM_ID', 'AGE'))
  ...
  public function getBaseTable() {
    return 'K12.Student.Status';
  }
  
  public function getBaseKeyFieldName() {
    return 'K12.Student.Status.ID';
  }
