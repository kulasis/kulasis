...
class CoreStudentRecord extends Record {
  ...
  public function getSelectedRecordBarTemplate() {
    return 'KulaK12StudentBundle::CoreRecord/selected_record_student.html.twig';
  }
  
  public function getRecordBarTemplate() {
    return 'KulaK12StudentBundle::CoreRecord/record_student.html.twig';
  }
  
  public function getFromDifferentType($record_type, $record_id) {
    if ($record_type == 'Core.K12.Student.Status' OR $record_type == 'Core.HEd.Student.Status') {
