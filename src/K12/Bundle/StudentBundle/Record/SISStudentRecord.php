...
class SISStudentRecord extends Record {
  ...
  public function getSelectedRecordBarTemplate() {
    return 'KulaK12StudentBundle::SISRecord/selected_record_student.html.twig';
  }
  
  public function getRecordBarTemplate() {
    return 'KulaK12StudentBundle::SISRecord/record_student.html.twig';
  }
  
  public function getFromDifferentType($record_type, $record_id) {
    if ($record_type == 'SIS.K12.Student.Status' OR $record_type == 'SIS.HEd.Student.Status') {
