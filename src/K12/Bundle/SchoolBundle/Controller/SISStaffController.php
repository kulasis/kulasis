...
class SISStaffController extends Controller {
  ...
  public function indexAction() {
    $this->authorize();
    $this->processForm();
    $this->setRecordType('SIS.K12.Staff');
    ...
    return $this->render('KulaK12SchoolBundle:SISStaff:index.html.twig', array('staff' => $staff));
  }
  ...
  public function staff_orgtermsAction() {
    ...
    return $this->render('KulaK12SchoolBundle:SISStaff:orgterms.html.twig', array('stafforgterms' => $stafforgterms));  
  }
  ...
  public function addAction() {
    ...
    if ($staff_orgterm_addition = $this->form('add', 'K12.Staff.OrganizationTerm', 'new')) {
      ...
      return $this->forward('sis_K12_school_staff', array('record_type' => 'SIS.K12.Staff', 'record_id' => $staff_orgterm_addition['K12.Staff.OrganizationTerm.StaffID']), array('record_type' => 'SIS.K12.Staff', 'record_id' => $staff_orgterm_addition['K12.Staff.OrganizationTerm.StaffID']));
    }
    ...
    return $this->render('KulaK12SchoolBundle:SISStaff:add.html.twig', array('constituents' => $constituents));
  }
  
  public function add_constituentAction() {
    $this->authorize();
    $this->formAction('sis_K12_school_staff_create_constituent');
    return $this->render('KulaK12SchoolBundle:SISStaff:add_constituent.html.twig');
  }
