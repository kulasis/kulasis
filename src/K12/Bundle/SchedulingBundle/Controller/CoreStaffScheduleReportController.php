...
class CoreStaffScheduleReportController extends ReportController {
  ...
  public function indexAction() {
    $this->authorize();
    if (($this->request->query->get('record_type') == 'Core.K12.Staff' || $this->request->query->get('record_type') == 'Core.K12.Staff.SchoolTerm') AND $this->request->query->get('record_id') != '')
    ...
    return $this->render('KulaK12SchedulingBundle:CoreStaffScheduleReport:reports_staffschedule.html.twig');
  }
