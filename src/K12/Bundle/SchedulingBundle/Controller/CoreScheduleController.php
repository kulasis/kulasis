...
class CoreScheduleController extends Controller {
  ...
  public function indexAction() {
    ...
    if ($this->request->request->get('drop')) {
      ...
      $classes_to_delete = $this->request->request->get('drop')['K12.Student.Class'];
      $drop_date = date('Y-m-d', strtotime($this->request->request->get('non')['K12.Student.Class']['K12.Student.Class.DropDate']));
    ...
    return $this->render('KulaK12SchedulingBundle:CoreSchedule:index.html.twig', array('drop_date' => $drop_date, 'classes' => $this->_currentSchedule()));
  }
  ...
  public function gradesAction() {
    ...
    if (isset($edit_request['K12.Student.CourseHistory'])) {
      $course_history_service = $this->get('kula.K12.grading.coursehistory');
    ...
    return $this->render('KulaK12SchedulingBundle:CoreSchedule:grades.html.twig', array('classes' => $classes,  'classes_history' => $classes_history));
  }
  ...
  public function historyAction() {
    ...
    return $this->render('KulaK12SchedulingBundle:CoreSchedule:history.html.twig', array('classes' => $classes));
  }
  ...
  public function detailAction($id) {
    ...
    return $this->render('KulaK12SchedulingBundle:CoreSchedule:schedule_detail.html.twig', array('class' => $class));  
  }
  ...
  public function addAction() {
    ...
    if ($this->request->request->get('add')) {  
      ...
      if (isset($this->request->request->get('add')['K12.Student.Class']['new']['K12.Student.Class.SectionID']))
        $new_classes = $this->request->request->get('add')['K12.Student.Class']['new']['K12.Student.Class.SectionID'];
      $start_date = date('Y-m-d', strtotime($this->request->request->get('add')['K12.Student.Class']['new']['K12.Student.Class.StartDate']));
    ...
    if ($this->request->request->get('wait_list')) {
      ...
      if (isset($this->request->request->get('wait_list')['K12.Student.WaitList']['K12.Student.WaitList.SectionID']))
        $new_classes = $this->request->request->get('wait_list')['K12.Student.WaitList']['K12.Student.WaitList.SectionID'];
    ...
    if ($this->request->request->get('add')) {
      return $this->forward('Core_K12_Scheduling_StudentSchedule', array('record_type' => 'Core.K12.Student.Status', 'record_id' => $this->record->getSelectedRecordID()), array('record_type' => 'Core.K12.Student.Status', 'record_id' => $this->record->getSelectedRecordID()));
    }
    
    if ($this->request->request->get('wait_list')) {
      return $this->forward('Core_K12_Scheduling_StudentSchedule_WaitList', array('record_type' => 'Core.K12.Student.Status', 'record_id' => $this->record->getSelectedRecordID()), array('record_type' => 'Core.K12.Student.Status', 'record_id' => $this->record->getSelectedRecordID()));
    }
    ...
    return $this->render('KulaK12SchedulingBundle:CoreSchedule:add.html.twig', array('search_classes' => $search_classes, 'classes' => $this->_currentSchedule(), 'start_date' => $start_date));  
  }
  ...
  public function waitlistAction() {
    ...
    if ($this->request->request->get('drop')) {
      ...
      $classes_to_delete = $this->request->request->get('drop')['K12.Student.WaitList'];
    ...
    return $this->render('KulaK12SchedulingBundle:CoreSchedule:waitlist.html.twig', array('classes' => $classes));
  }
