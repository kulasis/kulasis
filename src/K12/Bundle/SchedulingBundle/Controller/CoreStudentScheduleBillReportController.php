...
class CoreStudentScheduleBillReportController extends ReportController {
  ...
  public function indexAction() {
    $this->authorize();
    if ($this->request->query->get('record_type') == 'Core.K12.Student.Status' AND $this->request->query->get('record_id') != '')
    ...
    return $this->render('KulaK12SchedulingBundle:CoreStudentScheduleReport:reports_studentschedule.html.twig');
  }
