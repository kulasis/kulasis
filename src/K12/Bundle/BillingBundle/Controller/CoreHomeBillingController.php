...
class CoreHomeBillingController extends Controller {
  ...
  public function pendingAction() {
    ...
    return $this->render('KulaK12BillingBundle:CoreHomeBilling:pending.html.twig', array('transactions' => $transactions));
  }
  ...
  public function transaction_detailAction($constituent_transaction_id) {
    ...
    return $this->render('KulaK12BillingBundle:CoreHomeBilling:transactions_detail.html.twig', array('transaction' => $transaction, 'applied_transactions' => $applied_transactions, 'applied_transactions_total' => $applied_transactions_total));
  }
