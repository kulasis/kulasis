...
class SISTuitionRatesController extends Controller {
  ...
  public function indexAction() {
    ...
    return $this->render('KulaK12BillingBundle:SISTuitionRates:index.html.twig', array('rates'=> $rates));
  }
  ...
  public function transactionsAction($tuition_rate_id) {
    ...
    return $this->render('KulaK12BillingBundle:SISTuitionRates:transactions.html.twig', array('transactions' => $transactions, 'tuition_rate_id' => $tuition_rate_id));
  }
  ...
  public function studentsAction($tuition_rate_id) {
    ...
    return $this->render('KulaK12BillingBundle:SISTuitionRates:students.html.twig', array('students' => $students, 'tuition_rate_id' => $tuition_rate_id));
  }
  ...
  public function refundsAction($tuition_rate_id) {
    ...
    return $this->render('KulaK12BillingBundle:SISTuitionRates:refunds.html.twig', array('refunds' => $refunds, 'tuition_rate_id' => $tuition_rate_id));
  }
