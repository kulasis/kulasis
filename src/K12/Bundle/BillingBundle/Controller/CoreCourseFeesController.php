...
class CoreCourseFeesController extends Controller {
  ...
  public function indexAction() {
    ...
    return $this->render('KulaK12BillingBundle:CoreCourseFees:fees_index.html.twig', array('fees' => $fees, 'refund_fees' => $refund_fees, 'organization_term_id' => $this->focus->getOrganizationTermID(), 'organization_term_id_display' => $org_term['TERM_ABBREVIATION'] . ' / ' . $org_term['ORGANIZATION_NAME']));
