...
class SISCourseFeesController extends Controller {
  ...
  public function indexAction() {
    ...
    return $this->render('KulaK12BillingBundle:SISCourseFees:fees_index.html.twig', array('fees' => $fees, 'refund_fees' => $refund_fees, 'organization_term_id' => $this->focus->getOrganizationTermID(), 'organization_term_id_display' => $org_term['TERM_ABBREVIATION'] . ' / ' . $org_term['ORGANIZATION_NAME']));
  ...
  public function sectionFeesAction() {
    ...
    return $this->render('KulaK12BillingBundle:SISCourseFees:section.html.twig', array('fees' => $fees, 'course_fees' => $course_fees, 'course_refund_fees' => $course_refund_fees, 'refund_fees' => $refund_fees));
