...
class CoreTuitionRatesController extends Controller {
  ...
  public function indexAction() {
    ...
    return $this->render('KulaK12BillingBundle:CoreTuitionRates:index.html.twig', array('rates'=> $rates));
  }
  ...
  public function transactionsAction($tuition_rate_id) {
    ...
    return $this->render('KulaK12BillingBundle:CoreTuitionRates:transactions.html.twig', array('transactions' => $transactions, 'tuition_rate_id' => $tuition_rate_id));
  }
  ...
  public function studentsAction($tuition_rate_id) {
    ...
    return $this->render('KulaK12BillingBundle:CoreTuitionRates:students.html.twig', array('students' => $students, 'tuition_rate_id' => $tuition_rate_id));
  }
  ...
  public function refundsAction($tuition_rate_id) {
    ...
    return $this->render('KulaK12BillingBundle:CoreTuitionRates:refunds.html.twig', array('refunds' => $refunds, 'tuition_rate_id' => $tuition_rate_id));
  }
