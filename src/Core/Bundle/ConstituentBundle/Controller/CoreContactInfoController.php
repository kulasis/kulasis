...
class CoreContactInfoController extends Controller {
  ...
  public function addressesAction() {
    ...
    return $this->render('KulaCoreConstituentBundle:CoreContactInfo:addresses.html.twig', array('address_types' => $address_types, 'addresses' => $addresses, 'primary_addresses' => $primary_addresses, 'constituent' => $constituent_primary_addresses));
  }
  
  public function detailAction($sub_id) {
    $this->authorize();
    $this->setRecordType('Core.Constituent');
    ...
    return $this->render('KulaCoreConstituentBundle:CoreContactInfo:addresses_detail.html.twig', array('address' => $address));
  }
  ...
  public function add_addressAction() {
    ...
    if ($this->poster()) {
      $address_result = $this->poster()->getAddedIDs('Core.Constituent.Address');
      if ($address_result) {  
        return $this->forward('Core_Constituent_addresses', array('record_type' => 'Core.Constituent', 'record_id' => $this->record->getSelectedRecordID()), array('record_type' => 'Core.Constituent', 'record_id' => $this->record->getSelectedRecordID()));
      }
    }
    
    return $this->render('KulaCoreConstituentBundle:CoreContactInfo:addresses_add.html.twig');
  }
  ...
  public function phonesAction() {
    ...
    return $this->render('KulaCoreConstituentBundle:CoreContactInfo:phones.html.twig', array('phones' => $phones, 'primary_phones' => $primary_phones));
  }
  ...
  public function emailAddressesAction() {
    ...
    return $this->render('KulaCoreConstituentBundle:CoreContactInfo:emailaddresses.html.twig', array('emails' => $emails, 'primary_emails' => $primary_emails));
  }
