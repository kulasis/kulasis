...
class CoreBillingConstituentLedgerReportController extends ReportController {
  ...
  public function indexAction() {
    ...
    return $this->render('KulaCoreBillingBundle:CoreBillingConstituentLedgerReport:reports_billingledger.html.twig', array('fa_menu' => $financial_aid_menu));
  }
  ...
  {  
    ...
    $this->pdf = new \Kula\Core\Bundle\BillingBundle\Report\BillingConstituentLedgerReport("P");
