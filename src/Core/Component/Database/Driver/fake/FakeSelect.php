...
/**
 * @file
 * Contains Kula\Core\Component\Database\Driver\fake\FakeSelect.
 */
...
use Kula\Core\Component\Database\Query\Select;
use Kula\Core\Component\Database\Query\SelectInterface;
...
class FakeSelect extends Select {
   ...
   *
   * @param \Kula\Core\Component\Database\Query\Condition $condition_group
   *   The condition group to check.
   * @param array $rows
   *   An array of rows excluding non-matching rows.
   *
   * @return \Kula\Core\Component\Database\Driver\fake\ConditionResolver
