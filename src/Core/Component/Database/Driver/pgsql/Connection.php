...
/**
 * @file
 * Definition of Kula\Core\Component\Database\Driver\pgsql\Connection
 */
...
use Kula\Core\Component\Database\StatementInterface;
...
class Connection extends DatabaseConnection {
   ...
   *
   * @see Kula\Core\Component\Database\Connection::pushTransaction().
   */
   ...
   *   "mimic_implicit_commit" is used.
   *
   * @see Kula\Core\Component\Database\Connection::popTransaction().
   */
