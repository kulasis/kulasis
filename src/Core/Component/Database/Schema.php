...
/**
 * @file
 * Definition of Kula\Core\Component\Database\Schema
 */
...
abstract class Schema implements PlaceholderInterface {
   ...
   *
   * @return \Kula\Core\Component\Database\Query\Condition
   *   A Condition object.
   */
   ...
   *
   * @throws \Kula\Core\Component\Database\SchemaObjectDoesNotExistException
   *   If the specified table doesn't exist.
   * @throws \Kula\Core\Component\Database\SchemaObjectExistsException
