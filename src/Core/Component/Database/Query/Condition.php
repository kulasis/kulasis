...
/**
 * @file
 * Definition of Kula\Core\Component\Database\Query\Condition
 */

namespace Kula\Core\Component\Database\Query;

use Kula\Core\Component\Database\Connection;
use Kula\Core\Component\Database\InvalidQueryException;
...
class Condition implements ConditionInterface, \Countable {
   ...
   *
   * Only copies fields that implement Kula\Core\Component\Database\Query\ConditionInterface. Also sets
