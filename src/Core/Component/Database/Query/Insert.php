...
/**
 * @file
 * Definition of Kula\Core\Component\Database\Query\Insert
 */
...
class Insert extends Query {
   ...
   *
   * @param \Kula\Core\Component\Database\Query\SelectInterface $query
   ...
   *
   * @throws \Kula\Core\Component\Database\Query\FieldsOverlapException
   * @throws \Kula\Core\Component\Database\Query\NoFieldsException
   */
