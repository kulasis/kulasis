...
/**
 * @file
 * Definition of Kula\Core\Component\Database\Query\Merge
 */
...
class Merge extends Query implements ConditionInterface {
   ...
   *
   * Same as \Kula\Core\Component\Database\Query\Merge::keys() but offering a signature
   ...
   * @return $this
   *
   * @see \Kula\Core\Component\Database\Query\Merge::keys()
   */
