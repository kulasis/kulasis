...
/**
 * @file
 * Contains \Kula\Core\Component\Database\Query\Select.
 */
...
class Select extends Query implements SelectInterface {
   ...
   *
   * @var \Kula\Core\Component\Database\Query\Condition
   */
  protected $where;
   ...
   *
   * @see \Kula\Core\Component\Database\Query\ConditionInterface::conditions()
   */
   ...
   *
   * @return \Kula\Core\Component\Database\Query\Select
