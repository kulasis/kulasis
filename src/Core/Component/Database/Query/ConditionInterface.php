...
/**
 * @file
 * Definition of Kula\Core\Component\Database\Query\ConditionInterface
 */
...
interface ConditionInterface {
   ...
   *
   * @return \Kula\Core\Component\Database\Query\ConditionInterface
   *   The called object.
   *
   * @see \Kula\Core\Component\Database\Query\ConditionInterface::isNull()
   * @see \Kula\Core\Component\Database\Query\ConditionInterface::isNotNull()
   */
   ...
   *
   * @param \Kula\Core\Component\Database\Query\SelectInterface $select
