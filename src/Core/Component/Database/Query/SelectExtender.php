...
/**
 * @file
 * Definition of Kula\Core\Component\Database\Query\SelectExtender
 */
...
class SelectExtender implements SelectInterface {
   ...
   *
   * @var \Kula\Core\Component\Database\Query\SelectInterface
   */
  protected $query;
   ...
   *
   * @var \Kula\Core\Component\Database\Connection
   */
  ...
  /**
   * Implements Kula\Core\Component\Database\Query\PlaceholderInterface::uniqueIdentifier().
   */
  ...
  /**
   * Implements Kula\Core\Component\Database\Query\PlaceholderInterface::nextPlaceholder().
   */
  public function nextPlaceholder() {
    return $this->placeholder++;
  }

  /* Implementations of Kula\Core\Component\Database\Query\AlterableInterface. */
  ...
  /* Implementations of Kula\Core\Component\Database\Query\ConditionInterface for the WHERE clause. */
  ...
  /* Implementations of Kula\Core\Component\Database\Query\ConditionInterface for the HAVING clause. */
  ...
  /* Implementations of Kula\Core\Component\Database\Query\ExtendableInterface. */
