...
/**
 * @file
 * Definition of Kula\Core\Component\Database\StatementInterface
 */
 ...
 * @code
 * class Kula\Core\Component\Database\Driver\oracle\Statement extends PDOStatement implements Kula\Core\Component\Database\StatementInterface {}
 * @endcode
 * or define their own class. If defining their own class, they will also have
 * to implement either the Iterator or IteratorAggregate interface before
 * Kula\Core\Component\Database\StatementInterface:
 * @code
 * class Kula\Core\Component\Database\Driver\oracle\Statement implements Iterator, Kula\Core\Component\Database\StatementInterface {}
 * @endcode
 *
 * @ingroup database
 */
interface StatementInterface extends \Traversable {
   ...
   *   statement executed or throws \Kula\Core\Component\Database\RowCountException
   *   if the last executed statement was SELECT.
   *
   * @throws \Kula\Core\Component\Database\RowCountException
   */
