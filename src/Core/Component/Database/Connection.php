...
/**
 * @file
 * Definition of Kula\Core\Component\Database\Connection
 */

namespace Kula\Core\Component\Database;

use Kula\Core\Component\Database\TransactionNoActiveException;
use Kula\Core\Component\Database\TransactionOutOfOrderException;
...
abstract class Connection implements \Serializable {
   ...
   * @var string
   */
  protected $statementClass = 'Kula\Core\Component\Database\Statement';
   ...
   *   table names.
   *
   * @return \Kula\Core\Component\Database\StatementInterface
   ...
   *
   * @throws \PDOException
   * @throws \Kula\Core\Component\Database\IntegrityConstraintViolationException
   */
   ...
   *
   * @return \Kula\Core\Component\Database\Query\SelectInterface
   *   An appropriate SelectQuery object for this database connection. Note that
   *   it may be a driver-specific subclass of SelectQuery, depending on the
   *   driver.
   *
   * @see \Kula\Core\Component\Database\Query\Select
   */
   ...
   *   An array of options on the query.
   *
   * @return \Kula\Core\Component\Database\Query\Insert
   *   A new Insert query object.
   *
   * @see \Kula\Core\Component\Database\Query\Insert
   */
   ...
   *   An array of options on the query.
   *
   * @return \Kula\Core\Component\Database\Query\Merge
   *   A new Merge query object.
   *
   * @see \Kula\Core\Component\Database\Query\Merge
   */
   ...
   *   An array of options on the query.
   *
   * @return \Kula\Core\Component\Database\Query\Update
   *   A new Update query object.
   *
   * @see \Kula\Core\Component\Database\Query\Update
   */
   ...
   *   An array of options on the query.
   *
   * @return \Kula\Core\Component\Database\Query\Delete
   *   A new Delete query object.
   *
   * @see \Kula\Core\Component\Database\Query\Delete
   */
   ...
   *   An array of options on the query.
   *
   * @return \Kula\Core\Component\Database\Query\Truncate
   *   A new Truncate query object.
   *
   * @see \Kula\Core\Component\Database\Query\Truncate
   */
   ...
   *
   * @return \Kula\Core\Component\Database\Schema
   ...
   * Kula\Core\Component\Database\Query\Condition::mapConditionOperator().
   *
   * @param $string
   ...
   *
   * @return \Kula\Core\Component\Database\Transaction
   *   A Transaction object.
   *
   * @see \Kula\Core\Component\Database\Transaction
   */
   ...
   *
   * @throws \Kula\Core\Component\Database\TransactionNoActiveException
   *
   * @see \Kula\Core\Component\Database\Transaction::rollback()
   */
   ...
   *
   * @throws \Kula\Core\Component\Database\TransactionNameNonUniqueException
   *
   * @see \Kula\Core\Component\Database\Transaction
   */
   ...
   *
   * @throws \Kula\Core\Component\Database\TransactionNoActiveException
   * @throws \Kula\Core\Component\Database\TransactionCommitFailedException
   *
   * @see \Kula\Core\Component\Database\Transaction
   */
   ...
   *
   * @see \Kula\Core\Component\Database\Query\Condition::compile()
   */
   ...
   *
   * @throws \Kula\Core\Component\Database\TransactionExplicitCommitNotAllowedException
   *
   * @see \Kula\Core\Component\Database\Transaction
   */
