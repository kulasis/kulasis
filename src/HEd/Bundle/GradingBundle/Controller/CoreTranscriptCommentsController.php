...
class CoreTranscriptCommentsController extends Controller {
  ...
  public function indexAction() {
    ...
    return $this->render('KulaHEdGradingBundle:CoreTranscriptComments:comments.html.twig', array('comments' => $comments));  
  }
