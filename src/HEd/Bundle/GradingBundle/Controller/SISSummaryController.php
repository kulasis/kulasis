...
class SISSummaryController extends Controller {
  ...
  public function termsAction() {
    ...
    return $this->render('KulaHEdGradingBundle:SISSummary:terms.html.twig', array('terms' => $gpa));  
  }
  ...
  public function calculateTermTotalsAction() {
    ...
    if ($this->request->query->get('record_type') == 'SIS.HEd.Student' AND $this->request->query->get('record_id') != '')
      $this->setRecordType('SIS.HEd.Student');
    return $this->render('KulaHEdGradingBundle:SISSummary:action_calculateTermTotals.html.twig');
  }
