...
class CoreGradingSetupMarkScaleController extends Controller {
  ...
  public function indexAction() {
    ...
    return $this->render('KulaHEdGradingBundle:CoreGradingSetupMarkScale:mark_scales.html.twig', array('mark_scales' => $mark_scales));
  }
  ...
  public function detailAction($mark_scale_id) {
    ...
    return $this->render('KulaHEdGradingBundle:CoreGradingSetupMarkScale:mark_scale_detail.html.twig', array('marks' => $marks, 'mark_scale' => $mark_scale));
  }
}