...
class SISFinalGradesReportController extends ReportController {
  ...
  public function indexAction() {
    ...
    return $this->render('KulaHEdGradingBundle:SISFinalGradesReport:reports_finalgradesreport.html.twig');
  }
  ...
  {  
    ...
    $result = $this->db()->db_select('STUD_STUDENT', 'student')
      ...
      ->leftJoin('CONS_ADDRESS', 'home_address', 'home_address.CONSTITUENT_ID = stucon.CONSTITUENT_ID AND home_address.UNDELIVERABLE = \'N\' AND home_address.SEND_GRADES = \'Y\'')
