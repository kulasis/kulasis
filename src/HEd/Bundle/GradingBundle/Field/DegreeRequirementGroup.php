...
class DegreeRequirementGroup extends Field {
  ...
  public function select($schema, $param) {
    ...
    $result = $this->db()->db_select('STUD_STUDENT_DEGREES', 'studegrees')
      ...
      ->join('STUD_STUDENT_DEGREES_CONCENTRATIONS', 'stuconcentrations', 'studegrees.STUDENT_DEGREE_ID = stuconcentrations.STUDENT_DEGREE_ID')
      ->join('STUD_DEGREE_REQ_GRP', 'degreereqgrp', 'degreereqgrp.DEGREE_ID = degree.DEGREE_ID OR degreereqgrp.CONCENTRATION_ID = stuconcentrations.CONCENTRATION_ID')
