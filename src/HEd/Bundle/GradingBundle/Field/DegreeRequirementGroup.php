...
class DegreeRequirementGroup extends Field {
  ...
  public function select($schema, $param) {
    ...
    $result = $this->db()->db_select('STUD_STUDENT_DEGREES', 'studegrees')
      ...
      ->leftJoin('STUD_STUDENT_DEGREES_AREAS', 'stuareas', 'studegrees.STUDENT_DEGREE_ID = stuareas.STUDENT_DEGREE_ID')
      ->leftJoin('STUD_DEGREE_REQ_GRP', 'degreereqgrp', 'degreereqgrp.DEGREE_ID = degree.DEGREE_ID OR degreereqgrp.AREA_ID = stuareas.AREA_ID')
