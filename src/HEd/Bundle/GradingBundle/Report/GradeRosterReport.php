...
class GradeRosterReport extends BaseReport {
  ...
  {
    $this->setReportTitle('GRADE ROSTER');
    ...
    $this->SetLineWidth(.1);
      $header = array('#', 'Student ID', 'Last Name', 'First Name', 'Grade', 'Enter Code', 'Mark'); // 'Final Grade'
  ...
  public function Footer()
  {
    ...
    $this->Ln(5);
    $this->Cell(120,4,'Instructor Signature: _______________________________________',0,0,'L');
    $this->Cell(20,4,'Date: ________________',0,0,'R');
