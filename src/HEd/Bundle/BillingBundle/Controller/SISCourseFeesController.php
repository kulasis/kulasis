...
class SISCourseFeesController extends Controller {
  ...
  public function indexAction() {
    ...
    return $this->render('KulaHEdBillingBundle:SISCourseFees:fees_index.html.twig', array('fees' => $fees, 'refund_fees' => $refund_fees, 'organization_term_id' => $this->focus->getOrganizationTermID(), 'organization_term_id_display' => $org_term['TERM_ABBREVIATION'] . ' / ' . $org_term['ORGANIZATION_NAME']));
