...
class CoreBillingController extends Controller {
  ...
  public function balancesAction() {
    ...
    return $this->render('KulaHEdBillingBundle:CoreBilling:balances.html.twig', array('terms_wtih_balances' => $terms_with_balances, 'transactions' => $transactions, 'transactions_total' => $transactions_total, 'terms_total' => $terms_total, 'status' => $status));
  }
