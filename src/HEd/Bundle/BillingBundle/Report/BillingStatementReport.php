...
class BillingStatementReport extends \Kula\Component\Report\BaseReport {
	...
	public function remit_payment() {
		...
		$this->SetFont('Arial', '', 8);
		$this->Ln(4);
		$this->Cell(0,5, 'Oregon College of Art and Craft', '', 0,'L');
		$this->Ln(4);
		$this->Cell(0,5, 'Attn: BURSAR', '', 0,'L');
		$this->Ln(4);
		$this->Cell(0,5, '8245 Southwest Barnes Road', '', 0,'L');
		$this->Ln(4);
		$this->Cell(0,5, 'Portland, OR 97225', '', 0,'L');
		$this->Ln(25);
