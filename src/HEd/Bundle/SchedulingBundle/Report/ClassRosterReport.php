...
class ClassRosterReport extends \Kula\Component\Report\BaseReport {
	...
	{
		$this->setReportTitle('CLASS ROSTER');
    ...
    $this->SetLineWidth(.1);
    	$header = array('#', 'Student ID', 'Last Name', 'First Name', 'Grade', 'Enter Code', 'Concentration(s)'); // 'Final Grade'
