...
class CoreStudentScheduleBillReportController extends ReportController {
  
  public function indexAction() {
    $this->authorize();
    $this->formAction('Core_HEd_Scheduling_Reports_StudentScheduleBill_Generate');
  ...
  {  
    ...
    $result = $this->db()->db_select('STUD_STUDENT_CLASSES', 'class')
      ...
      ->fields('section', array('SECTION_ID', 'SECTION_NUMBER', 'SECTION_NAME', 'START_DATE', 'END_DATE', 'NO_CLASS_DATES', 'SUPPLIES_REQUIRED', 'SUPPLIES_OPTIONAL', 'SUPPLIES_PRICE'))
