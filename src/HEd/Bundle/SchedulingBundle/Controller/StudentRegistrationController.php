...
class StudentRegistrationController extends Controller {
  ...
  public function startAction($organization_term_id) {
    $this->authorize();
    $this->setRecordType('Student.HEd.Student');
    
    if ($this->record->getSelectedRecordID()) {
      $student_status_id = $this->get('kula.HEd.scheduling.registration')->enroll($this->record->getSelectedRecordID(), $organization_term_id);
      
      return $this->forward('Student_HEd_Registration_Catalog', array('student_status_id' => $student_status_id));
    }
