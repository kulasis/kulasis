...
class CoreBooksController extends Controller {
  ...
  public function booksAction() {
    ...
    return $this->render('KulaHEdSchedulingBundle:CoreBooks:books.html.twig', array('books' => $books, 'organization_term_id' => $this->focus->getOrganizationTermID(), 'organization_term_id_display' => $org_term['TERM_ABBREVIATION'] . ' / ' . $org_term['ORGANIZATION_NAME']));
  }
