  ...
  public function detailAction($id) {
    ...
    if ($discount_data = $this->request->request->get('discount')) {
      ...
      foreach($discount_data['HEd.Student.Class'] as $student_class_id => $field) {
        ...
        $transaction_service->addDiscount($field['HEd.Student.Class.Discount'], $this->record->getSelectedRecord()['STUDENT_ID'], $class_info['ORGANIZATION_TERM_ID'], $student_class_id, $payment_id);
