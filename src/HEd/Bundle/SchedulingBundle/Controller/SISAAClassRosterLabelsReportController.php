...
class SISAAClassRosterLabelsReportController extends ReportController {
  ...
  public function indexAction() {
    ...
    return $this->render('KulaK12SchedulingBundle:SISClassRosterReport:reports_classroster_labels.html.twig');
  }
