...
class SISClassRosterDirectoryReportController extends ReportController {
  
  public function indexAction() {
    $this->authorize();
    $this->formAction('sis_HEd_offering_sections_report_classroster_directory_generate');
  ...
  {  
    ...
    $pdf = new \Kula\HEd\Bundle\SchedulingBundle\Report\ClassRosterDirectoryReport("P");
