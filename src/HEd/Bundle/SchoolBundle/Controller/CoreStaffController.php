...
class CoreStaffController extends Controller {
  ...
  public function indexAction() {
    ...
    return $this->render('KulaHEdSchoolBundle:CoreStaff:index.html.twig', array('staff' => $staff));
  }
  ...
  public function staff_orgtermsAction() {
    ...
    return $this->render('KulaHEdSchoolBundle:CoreStaff:orgterms.html.twig', array('stafforgterms' => $stafforgterms));  
  }
  ...
  public function addAction() {
    ...
    return $this->render('KulaHEdSchoolBundle:CoreStaff:add.html.twig', array('constituents' => $constituents));
  }
