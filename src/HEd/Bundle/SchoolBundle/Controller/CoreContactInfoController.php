...
class CoreContactInfoController extends Controller {
  ...
  public function addressesAction() {
    $this->authorize();
    $this->processForm();
    $this->setRecordType('Core.HEd.Staff');
    ...
    return $this->render('KulaHEdSchoolBundle:CoreContactInfo:addresses.html.twig', array('address_types' => $address_types, 'addresses' => $addresses, 'primary_addresses' => $primary_addresses));
  }
  ...
  public function detailAction($id, $sub_id) {
    ...
    return $this->render('KulaHEdSchoolBundle:CoreContactInfo:addresses_detail.html.twig', array('address' => $address));
  }
  ...
  public function add_addressAction() {
    ...
    if ($this->poster()) {
      $address_result = $this->poster()->getAddedIDs('Core.Constituent.Address');
      if ($address_result) {  
        return $this->forward('core_HEd_school_staff_addresses', array('record_type' => 'Core.HEd.Staff', 'record_id' => $this->record->getSelectedRecordID()), array('record_type' => 'Core.HEd.Staff', 'record_id' => $this->record->getSelectedRecordID()));
      }
    }
    
    return $this->render('KulaHEdSchoolBundle:CoreContactInfo:addresses_add.html.twig');
  }
  ...
  public function phonesAction() {
    ...
    return $this->render('KulaHEdSchoolBundle:CoreContactInfo:phones.html.twig', array('phones' => $phones, 'primary_phones' => $primary_phones));
  }
  ...
  public function emailAddressesAction() {
    ...
    return $this->render('KulaHEdSchoolBundle:CoreContactInfo:emailaddresses.html.twig', array('emails' => $emails, 'primary_emails' => $primary_emails));
  }
  ...
  public function emergencyContactsAction() {
    ...
    return $this->render('KulaHEdSchoolBundle:CoreContactInfo:emergencycontacts.html.twig', array('emergency_contacts' => $emergency));
  }
