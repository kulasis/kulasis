...
class CoreAwardsController extends Controller {
  ...
  public function indexAction() {
    ...
    return $this->render('KulaHEdFinancialAidBundle:CoreAwards:awards.html.twig', array('fin_aid_year' => $fin_aid_year['FINANCIAL_AID_YEAR'], 'awards' => $awards));
  }
  ...
  public function awards_historyAction() {
    ...
    return $this->render('KulaHEdFinancialAidBundle:CoreAwards:awards_history.html.twig', array('awards' => $awards));
  }
  ...
  public function billingAction() {
    ...
    return $this->render('KulaHEdFinancialAidBundle:CoreAwards:billing.html.twig', array('transactions' => $transactions));
  }
