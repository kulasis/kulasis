...
class CoreHomeFinancialAidController extends Controller {
  
  public function pendingAction() {
    $this->authorize();
    $this->processForm();
    $this->setRecordType('Core.FAID.AwardCode');
    ...
    return $this->render('KulaHEdFinancialAidBundle:CoreHomeFinancialAid:pending.html.twig', array('awards' => $awards, 'gross_total' => $gross_total, 'net_total' => $net_total));
  }
  ...
  public function postedAction() {
    ...
    return $this->render('KulaHEdFinancialAidBundle:CoreHomeFinancialAid:posted.html.twig', array('transactions' => $transactions));
  }
