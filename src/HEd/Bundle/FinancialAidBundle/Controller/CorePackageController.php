...
class CorePackageController extends Controller {
  ...
  public function indexAction() {
    ...
    return $this->render('KulaHEdFinancialAidBundle:CorePackage:package_index.html.twig', array('award_year' => $award_year, 'award_terms' => $award_terms, 'awards' => $awards, 'awards_terms_totals' => $awards_terms_totals, 'pfaids_exempt' => $pfaids_exempt));
  }
}