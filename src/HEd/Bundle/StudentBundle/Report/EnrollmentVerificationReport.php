...
class EnrollmentVerificationReport extends \Kula\Component\Report\BaseReport {
	...
	public function content() {
		...
		$this->Ln(8);
		$this->Write(5, 'Oregon College of Art and Craft Certification system is designed to expedite the sharing of information with many institutions.  We appreciate your accepting this certification since hand-processed forms slow our response.');
		$this->Ln(8);
		$this->Write(5, 'This verification is valid only when it bears the imprinted seal of Oregon College of Art and Craft and the facsimile signature of the Registrar or Director of Financial Aid.');
		$this->Ln(10);
		// Column headings
