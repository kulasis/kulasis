...
class CoreContactInfoController extends Controller {
  ...
  public function addressesAction() {
    ...
    return $this->render('KulaHEdStudentBundle:CoreContactInfo:addresses.html.twig', array('address_types' => $address_types, 'addresses' => $addresses, 'primary_addresses' => $primary_addresses, 'constituent' => $constituent_primary_addresses));
  }
  ...
  public function detailAction($id, $sub_id) {
    ...
    return $this->render('KulaHEdStudentBundle:CoreContactInfo:addresses_detail.html.twig', array('address' => $address));
  }
  ...
  public function add_addressAction() {
    ...
    return $this->render('KulaHEdStudentBundle:CoreContactInfo:addresses_add.html.twig');
  }
  ...
  public function phonesAction() {
    ...
    return $this->render('KulaHEdStudentBundle:CoreContactInfo:phones.html.twig', array('phones' => $phones, 'primary_phones' => $primary_phones));
  }
  ...
  public function emailAddressesAction() {
    ...
    return $this->render('KulaHEdStudentBundle:CoreContactInfo:emailaddresses.html.twig', array('emails' => $emails, 'primary_emails' => $primary_emails));
  }
  ...
  public function emergencyContactsAction() {
    ...
    if ($this->record->getSelectedRecordID()) {
      $emergency = $this->db()->db_select('STUD_STUDENT_EMERGENCY_CONTACT', 'emergency')
        ->fields('emergency', array('SORT', 'EMERGENCY_CONTACT_ID', 'EMERGENCY_CONTACT_NAME', 'EMERGENCY_CONTACT_PHONE', 'EMERGENCY_CONTACT_EMAIL', 'AUTHORIZED_DRIVER', 'EMERGENCY_CONTACT', 'REMOVED'))
        ->condition('STUDENT_ID', $this->record->getSelectedRecordID())
        ->orderBy('SORT')
    ...
    return $this->render('KulaHEdStudentBundle:CoreContactInfo:emergencycontacts.html.twig', array('emergency_contacts' => $emergency));
  }
