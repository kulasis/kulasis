...
class CoreParentController extends Controller {
  ...
  public function indexAction() {
    ...
    return $this->render('KulaHEdStudentBundle:CoreParent:index.html.twig', array('addresses' => $addresses, 'phones' => $phones, 'emails' => $emails));
  }
  ...
  public function deleteAction() {
    ...
    if ($this->newPoster()->delete('HEd.Parent', $this->record->getSelectedRecordID())->process()->getResult()) {
      $this->addFlash('success', 'Deleted parent.');
    } else {
      $this->addFlash('error', 'Unable to delete parent.');
    }
    
    return $this->forward('core_HEd_student_parent_basic');
  ...
  public function childrenAction() {
    ...
    return $this->render('KulaHEdStudentBundle:CoreParent:children.html.twig', array('children' => $children));
