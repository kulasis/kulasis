...
class CoreHomeHoldsController extends Controller {
  
  public function indexAction() {
    $this->authorize();
    $this->processForm();
    $this->setRecordType('Core.HEd.Hold');
    ...
    return $this->render('KulaHEdStudentBundle:CoreHomeHolds:index.html.twig', array('holds' => $holds));
  }
