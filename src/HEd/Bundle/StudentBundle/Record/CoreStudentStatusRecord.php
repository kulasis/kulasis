...
class CoreStudentStatusRecord extends Record {
  ...
  public function getSelectedRecordBarTemplate() {
    return 'KulaHEdStudentBundle::CoreRecord/selected_record_student_status.html.twig';
  }
  
  public function getRecordBarTemplate() {
    return 'KulaHEdStudentBundle::CoreRecord/record_student_status.html.twig';
  }
  
  public function getFromDifferentType($record_type, $record_id) {
    if ($record_type == 'Core.HEd.Student' OR $record_type == 'Core.K12.Student') {
  ...
  public function getInfo($record_id) {
    $result = $this->db()->db_select('STUD_STUDENT_STATUS', 'STUD_STUDENT_STATUS')
      ...
      ->fields('constituent', array('CONSTITUENT_ID', 'PERMANENT_NUMBER', 'LAST_NAME', 'FIRST_NAME', 'MIDDLE_NAME', 'GENDER', 'RACE'))
